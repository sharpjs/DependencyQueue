...
{
    /// <summary>
    ///   A read-only view over an exclusively-locked dictionary that maps
    ///   topic name keys to <see cref="DependencyQueueTopic{T}"/> values.
    /// </summary>
        ...
        : IReadOnlyDictionary<string, DependencyQueueTopic<T>.View>
    {
        ...
        /// <summary>
        ///   A read-only view over the collection of keys of an
        ...
        /// <summary>
        ///   An enumerator over an exclusively-locked dictionary that maps
        ///   topic name keys to <see cref="DependencyQueueTopic{T}"/> values.
        /// </summary>
